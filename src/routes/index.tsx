      ...
      <section id="video" className="py-12 fade">
        <div className="max-w-5xl mx-auto px-6">
          <div className="relative rounded-3xl overflow-hidden shadow-glow">
            ...
            <video className="w-full h-full object-cover min-h-[520px]" autoPlay loop muted playsInline preload="metadata">
            ...
            <div className="absolute inset-0 z-20 flex flex-col justify-center px-8 md:px-16">
              <p className="text-yellow-400 uppercase tracking-[0.3em] text-sm mb-3">Bereit für deinen nächsten Look?</p>
              <h2 className="text-4xl md:text-5xl font-black leading-tight">
                Dein perfekter<br /><span className="gold">Haarschnitt</span><br />beginnt mit einem Termin.
              </h2>
              <p className="text-white/70 max-w-xl mt-5 text-base md:text-lg leading-relaxed">
              ...
              <div className="flex flex-wrap gap-3 mt-6">
                <a href="tel:+41765404514" className="btn inline-flex items-center gap-2 bg-yellow-500 text-black font-bold rounded-full px-7 py-3.5">📞 Termin buchen – 076 540 45 14</a>
                <a href="https://wa.me/41765404514" target="_blank" rel="noreferrer" className="btn inline-flex items-center gap-2 bg-green-500 text-white font-bold rounded-full px-7 py-3.5">
